...
import com.huskerdev.gpkt.apis.opencl.OpenCLBindings.Companion.nSetKernelArg1d
...
internal actual fun createCL(): OpenCL = object: OpenCL() {
    ...
    override fun clReleaseContext(context: CLContext) =
