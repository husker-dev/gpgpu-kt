...
actual fun createMetal(requestedDeviceId: Int): Metal = object: Metal(requestedDeviceId){
    ...
    override fun createCommandEncoder(pipeline: MTLComputePipelineState): MTLComputeCommandEncoder {
    ...
    override fun execute(commandEncoder: MTLComputeCommandEncoder, instances: Int){
